...
export function VideoCard({ url, target, thumbnailUrl, videoUrl, duration, title, subtitle }) {
  ...
  return (
    <Link href={url} target={target}>
      ...
      <p className="mt-4 text-sm/6 font-semibold text-gray-950 dark:text-white">{title}</p>
