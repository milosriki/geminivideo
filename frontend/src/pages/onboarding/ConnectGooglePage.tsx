...
export default function ConnectGooglePage() {
  ...
  const handleConnect = async () => {
    ...
    try {
      ...
      const mockCustomerId = Math.floor(1000000000 + Math.random() * 9000000000).toString()
      setCustomerId(mockCustomerId)
      setIsConnected(true)

      const userId = 'demo-user-id'
      await fetch('/api/onboarding/step/connect-google', {
        method: 'PUT',
        headers: { 'Content-Type': 'application/json' },
        body: JSON.stringify({
          userId,
          data: { google_customer_id: mockCustomerId },
        }),
      })
    ...
    <div className="min-h-screen bg-zinc-950 text-white">
      ...
      <div className="max-w-7xl mx-auto px-6 py-8">
        <ProgressIndicator
          ...
          currentStep={3}
          completedSteps={new Set(['welcome', 'meta'])}
        />
      </div>
      ...
      <div className="max-w-4xl mx-auto px-6 pb-16">
        ...
        >
          <div className="text-center mb-12">
            <h1 className="text-4xl font-bold mb-4">Connect Google Ads</h1>
            <p className="text-lg text-zinc-400">
              Publish and manage your Google Search and Display campaigns
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-2 gap-8">
                ...
                {!isConnected ? (
                  <>
                    ...
                    <ul className="space-y-4 mb-8">
                      {[
                        'Google Ads account',
                        'Admin or Standard access level',
            ...
            <div className="space-y-6">
              <VideoTutorial
                ...
                description="Quick guide to connecting your Google Ads account"
              ...
              <div className="bg-zinc-900 border border-zinc-800 rounded-xl p-6">
                <h4 className="font-semibold mb-4 flex items-center gap-2">
                  Need Help?
                  <Tooltip content="We're here to help you connect your Google Ads account" />
                </h4>
                <ul className="space-y-3 text-sm text-zinc-400">
                  <li>• Don't have Google Ads? <a href="#" className="text-violet-400 hover:text-violet-300">Create account</a></li>
                  <li>• Need account access? <a href="#" className="text-violet-400 hover:text-violet-300">Request permissions</a></li>
                  <li>• Having issues? <a href="#" className="text-violet-400 hover:text-violet-300">Chat with support</a></li>
                </ul>
              </div>

              <div className="bg-blue-500/10 border border-blue-500/30 rounded-xl p-6">
                <h4 className="font-semibold text-blue-300 mb-2">Multi-Platform Power</h4>
                <p className="text-sm text-zinc-300">
                  With both Meta and Google connected, you can run unified campaigns across
                  all major platforms from one dashboard.
                </p>
              </div>
            </div>
          </div>
