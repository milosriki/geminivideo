...
export const processVideoWithCreative = async (
    ...
    return new Blob([(outputData as Uint8Array).buffer as ArrayBuffer], { type: 'video/mp4' });
};
...
export const extractAudio = async (
    ...
    return new Blob([(audioData as Uint8Array).buffer as ArrayBuffer], { type: 'audio/wav' });
};
