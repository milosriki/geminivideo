            ...
            sessionPromiseRef.current = connectLive({
                ...
                onmessage: async (message: LiveServerMessage) => {
                    ...
                    if ((message.serverContent as any)?.inputTranscription) {
                        setCurrentInput(prev => prev + (message.serverContent as any).inputTranscription.text);
                    }
                    if ((message.serverContent as any)?.outputTranscription) {
                        setCurrentOutput(prev => prev + (message.serverContent as any).outputTranscription.text);
                    }
